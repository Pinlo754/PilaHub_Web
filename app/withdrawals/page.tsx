            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-orange-50 border-b border-orange-200">
                  <tr>
                    <th className="px-6 py-3 text-left text-sm font-semibold text-orange-700">
                      Mã Yêu Cầu
                    </th>
                    <th className="px-6 py-3 text-left text-sm font-semibold text-orange-700">
                      Tên Người Nhận
                    ...
                    <th className="px-6 py-3 text-right text-sm font-semibold text-orange-700">
                      Số Tiền
                    </th>
                    <th className="px-6 py-3 text-left text-sm font-semibold text-orange-700">
                      Trạng Thái
                  ...
                  {filteredData.map((item, index) => (
                    ...
                    >
                      <td className="px-6 py-4 text-sm font-mono text-gray-600">
                        {item.walletWithdrawalId.substring(0, 8)}...
                      </td>
