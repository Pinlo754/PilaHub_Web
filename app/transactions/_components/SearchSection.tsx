    ...
    <div className="flex justify-between gap-4 mb-6">
      ...
      <div className="flex-1 relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 border-2 border-orange-100 rounded-lg focus:outline-none focus:border-orange-300 disabled:bg-gray-50"
        />
        {isSearching && (
          <div className="absolute right-3 top-3 w-5 h-5 border-2 border-orange-300 border-t-transparent rounded-full animate-spin" />
        )}
      </div>
