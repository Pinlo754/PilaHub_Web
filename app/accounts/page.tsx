              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b-2 border-orange-100">
                    <th className="text-left py-3 px-4 font-semibold text-orange-700">Mã tài khoản</th>
                    <th className="text-left py-3 px-4 font-semibold text-orange-700">Tên người dùng</th>
                    ...
                    <th className="text-left py-3 px-4 font-semibold text-orange-700">Vai trò</th>
                ...
                <tbody>
                  {accounts.map((account, index) => (
                    <tr key={index} className="border-b border-orange-100 hover:bg-orange-50">
                      <td className="py-3 px-4 text-gray-700">{account.id}</td>
                      ...
                      <td className="py-3 px-4 text-gray-700">{account.role}</td>
                      <td className="py-3 px-4 text-gray-700">{account.date}</td>
