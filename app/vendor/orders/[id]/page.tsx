...
export default function OrderDetails() {
  ...
  const fetchOrder = async () => {
    ...
    if (res.success && res.data) {
      ...
      const mapped = {
        ...
        shippingProvider: o.shipments[0]?.shippingProvider,
  ...
  const handleCreateShipment = async (payload: any) => {
    ...
    // Nếu có bất kỳ sản phẩm nào yêu cầu lắp đặt => bắt buộc SELF
    const finalPayload = hasInstallation
      ? {
          ...payload,
          shippingProvider: "SELF",
        }
      : payload;

    await OrderService.createShipmentProvider(shipmentId, finalPayload);
